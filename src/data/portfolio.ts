...
export const FEATURED_PROJECTS: FeaturedProject[] = [
  {
    ...
    screenshots: [
      { src: '/catintassist-habit-pills.png', caption: 'The dashboard at rest: habit pills, three-tier progress bars (blue = on-call, orange = off-call), and sprint targets' },
      { src: '/catintassist-dashboard.png', caption: 'Press the green button. Audio streams to Deepgram. The AI detects language and fills the left column (ENG) and right column (SPA) in real time.' },
      { src: '/catintassist1.png', caption: 'Live dual-column view: transcription in normal weight, suggested translation in lighter italic. Color cues tell you which is which instantly.' },
      { src: '/catintassist2.png', caption: 'Side-by-side suggested translation: when the speaker uses an uncommon orthopedics term, the AI suggests the medical equivalent. You decide whether to use it.' },
      { src: '/catintassist3.png', caption: 'Call timer running. Cash amount increasing per minute. The app does not replace the interpreter — it provides more material to make informed decisions.' },
      { src: '/catintassist4.png', caption: 'Call ends → money bag explodes → earnings drop into daily total. At logoff, daily total rolls into monthly accumulation.' },
      { src: '/catintassist-feature-7.png', caption: 'Habit tracker: stretch, eat, clean, pray between calls' },
      { src: '/catintassist-feature-8.png', caption: 'Quick notes: manual override when transcription fails' },
      { src: '/catintassist-feature-9.png', caption: 'Soundboard: prerecorded greetings to preserve voice' },
      { src: '/catintassist-feature-10.png', caption: 'Auto hold timer: silence detection + disconnect nudge' },
      { src: '/catintassist-feature-11.png', caption: 'Dictionary: dialect cover and medical term lookup' },
      { src: '/catintassist-feature-12.png', caption: 'Pinned posts: replay recurring statements without re-speaking' },
      { src: '/catintassist-feature-13.png', caption: 'Post-call summary: 30-second grace period for logging' },
      { src: '/catintassist-feature-14.png', caption: 'Stutter protection: algorithm deduplicates fast transcription' },
      { src: '/catintassist-feature-15.png', caption: 'Word count guard: live meter for relay length compliance' },
      { src: '/catintassist-feature-16.png', caption: 'Number editor: correct misheard digits inline' },
    ],
  },
  {
    id: 'catreader',
